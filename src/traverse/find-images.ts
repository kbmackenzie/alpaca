...
export async function globImages(config: KestrelConfig, folder: string): Promise<Either<string, string[]>> {
...
export async function copyImages(config: KestrelConfig, from: string, to: string): Promise<Either<string, string[]>> {
